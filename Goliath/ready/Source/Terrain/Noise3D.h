...
#define GRADIENT_NUMBER_MASK 15
#endif
#ifndef RGB_BYTES
#define RGB_BYTES 3
#endif
...
public:
	...
	static inline double get_noise(double x, double y, double z) {
		...
		int g000 = _permutations[i + _permutations[j + _permutations[k]]] & GRADIENT_NUMBER_MASK;
		int g001 = _permutations[i + _permutations[j + _permutations[k + 1]]] & GRADIENT_NUMBER_MASK;
		int g010 = _permutations[i + _permutations[j + 1 + _permutations[k]]] & GRADIENT_NUMBER_MASK;
		int g011 = _permutations[i + _permutations[j + 1 + _permutations[k + 1]]] & GRADIENT_NUMBER_MASK;
		int g100 = _permutations[i + 1 + _permutations[j + _permutations[k]]] & GRADIENT_NUMBER_MASK;
		int g101 = _permutations[i + 1 + _permutations[j + _permutations[k + 1]]] & GRADIENT_NUMBER_MASK;
		int g110 = _permutations[i + 1 + _permutations[j + 1 + _permutations[k]]] & GRADIENT_NUMBER_MASK;
		int g111 = _permutations[i + 1 + _permutations[j + 1 + _permutations[k + 1]]] & GRADIENT_NUMBER_MASK;
